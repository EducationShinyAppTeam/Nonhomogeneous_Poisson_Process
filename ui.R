            ...
            fluidPage(
              ...
              sidebarLayout(
                sidebarPanel(
                  ...
                  # uiOutput("design"),
                  # br(),
                  selectInput(inputId ="lambdatype",
                              withMathJax("Select which type of intensity 
                                          function you would like to choose."),
              ...
              tabsetPanel(id = "game",
                ...
                fluidRow(
                  column(width=8, 
                         ...
                         fluidRow(
                           column(width=6,  selectInput('challengeChoice', 
                ...
                fluidRow(
                  column(width=8, 
                    ...
                    p("Select which intensity function matches the graph."),
                    fluidRow(
                    column(width=6,  selectInput('challengeChoiceT', 
                                                 label = 'Intensity Function',
                                                 choices = c("Select Answer",
                                                             "constant", 
                                                             "linear", 
